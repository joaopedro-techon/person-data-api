  ...
  scenarios: {
    ...
    gradual_1000_tps: {
      ...
      stages: [
        ...
        { duration: '30s', target: 250 },   // 0 -> 250 TPS em 30s
        { duration: '30s', target: 500 },   // 250 -> 500 TPS em 30s
        { duration: '30s', target: 750 },   // 500 -> 750 TPS em 30s
        { duration: '30s', target: 1000 },  // 750 -> 1000 TPS em 30s
        { duration: '1m', target: 1000 },   // Estabiliza em 1000 TPS por 1 min
        
        // Mantém 1000 TPS por 15 minutos
        { duration: '15m', target: 1000 },  // Mantém 1000 TPS por 15 minutos
        
        // Ramp-down gradual: 1000 -> 0 TPS em 1 minuto
        { duration: '30s', target: 500 },   // 1000 -> 500 TPS em 30s
