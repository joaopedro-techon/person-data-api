...
export const options = {
  scenarios: {
    ...
    gradual_1000_tps: {
      ...
      stages: [
        ...
        { duration: '30s', target: 50 },   // 0 -> 250 TPS em 30s
        { duration: '30s', target: 100 },   // 250 -> 500 TPS em 30s
        { duration: '30s', target: 150 },   // 500 -> 750 TPS em 30s
        { duration: '30s', target: 300 },  // 750 -> 1000 TPS em 30s
        { duration: '1m', target: 500 },   // Estabiliza em 1000 TPS por 1 min
        
        // Mantém 1000 TPS por 15 minutos
        { duration: '10m', target: 500 },  // Mantém 1000 TPS por 15 minutos
        
        // Ramp-down gradual: 1000 -> 0 TPS em 1 minuto
        { duration: '30s', target: 250 },   // 1000 -> 500 TPS em 30s
  ...
  thresholds: {
    ...
    // Throughput
    'http_reqs': ['rate>=900'],         // Mínimo 900 req/s (permite margem de 100)
  },
};
